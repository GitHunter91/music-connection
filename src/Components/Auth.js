...
export default class Auth extends Component {
    ...
    login = () => {
        ...
        window.location = `https://id.twitch.tv/oauth2/authorize?client_id=${process.env.REACT_APP_TWITCH_CLIENT_ID}&redirect_uri=http://192.168.1.10:3000/auth/twitch/callback&response_type=code&scope=${scope}`
